...
ConfigParser is a configuration file parser for PHP 7.1 and up. It's a copy of [NoiseLabs ConfigParser](https://github.com/noiselabs/configparser.php), but with updated code.
